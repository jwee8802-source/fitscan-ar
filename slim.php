...
document.addEventListener("click", function(event) {
  ...
  <a id="account" href="account.php"><img src="image/account.png" alt="Profile"><span>Info</span></a>
...
<section class="categories">
  ...
  <div class="category-list">
    <div class="category-item">
      <img src="image/f1.png" alt="Slim Feet">
      <a href="#slim-feet"><p>Slim Feet</p></a>
    </div>
  </div>
</section>

<section class="bulky-shoes" id="slim-feet">
  <h2>Slim Shoes</h2>
  <div class="product-list">
    <?php
    $search = isset($_GET['search']) ? $mysqli->real_escape_string($_GET['search']) : '';
    $query = "SELECT * FROM inventory WHERE shoe_type LIKE '%slim%'";
    if (!empty($search)) {
    ...
    if ($result && $result->num_rows > 0) {
      ...
      echo '<p>No slim shoes matched your search.</p>';
    }
    ?>
  </div>
</section>
  ...
  <div class="form-container">
    ...
    <form id="preorder-form-content" method="POST" action="submit_inquiry.php">
      ...
      <input type="hidden" id="shoe_image" name="shoe_image">
       ...
       <input type="hidden" name="return_url" value="slim.php">

...
document.addEventListener("click", function(event) {
 ...
 <section class="bulky-shoes" id="running-feet">
  <a href="home.php">
  ...
  <div class="product-list">
    ...
    $query = "SELECT * FROM inventory WHERE shoe_type LIKE '%running%'";
    if (!empty($search)) {
    ...
    if ($result && $result->num_rows > 0) {
      ...
      echo '<p>No Running shoes matched your search.</p>';
    }
    ?>
  </div>
</section>
  ...
  <div class="form-container">
    ...
    <form id="preorder-form-content" method="POST" action="submit_inquiry.php">
      ...
      <input type="hidden" id="shoe_image" name="shoe_image">
       <!-- Single Inquiry -->
       <input type="hidden" name="return_url" value="running.php">

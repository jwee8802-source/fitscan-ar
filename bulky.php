...
<section class="categories">
  ...
  <div class="category-list">
    <div class="category-item">
      <img src="image/f1.png" alt="Bulky Feet">
      <a href="#bulky-feet">
        <p>Bulky Feet</p>
      </a>
    </div>
...
<section class="bulky-shoes" id="bulky-feet">
  <h2>Bulky Shoes</h2>
  <div class="product-list">
    <?php
    $search = isset($_GET['search']) ? $mysqli->real_escape_string($_GET['search']) : '';
    $query = "SELECT * FROM inventory WHERE shoe_type LIKE '%bulky%'";
    if (!empty($search)) {
    ...
    if ($result && $result->num_rows > 0) {
      ...
      echo '<p>No Bulky shoes matched your search.</p>';
    }
    ?>
  </div>
</section>
